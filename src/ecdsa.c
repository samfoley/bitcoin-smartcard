...
// Private key
uint8_t dA[BN8_SIZE] = {0x5e, 0x9d, 0x04, 0x20, 0x7c, 0x01, 0x61, 0x4d, 0x36, 0x1c, 0xc9, 0xe5, 0x7d, 0x79, 0x5d, 0x5c, 0xa7, 0x7b, 0x4d, 0x9e, 0x2b, 0xf9, 0x7f, 0xd1, 0x2d, 0xf0, 0xe2, 0x8e, 0xfb, 0x51, 0x5d, 0x74};
...
void ecdsa_set_private_key(bn8 key)
{
	bn8_copy(dA, key, BN8_SIZE);
}

void ecdsa_get_public_key(bn8 key)
{
	uint8_t xr[BN8_SIZE] = {0};
	uint8_t yr[BN8_SIZE] = {0};
